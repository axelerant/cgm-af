...
<div class="three_quarters">
	<h1>Resources</h1>
	<?php if(is_user_member_of_blog(get_current_user_id()) || current_user_can('manage_options')){ ?>
	<?php $resources_id = $wpdb->get_var( "SELECT cat_ID FROM {$wpdb->sitecategories} WHERE category_nicename = 'resources'" );
